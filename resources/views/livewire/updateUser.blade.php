<div class="block p-6 rounded-lg shadow-lg bg-white max-w-sm">
    <form>
        ...
        <table>
            <tr>
                <td>
                    <button type="submit" wire:click.prevent="updateUser()" class="flex px-4 py-2 bg-gray-100 text-gray-900 cursor-pointer hover:bg-blue-200 focus:text-blue-700 focus:bg-blue-200 focus:outline-none focus:ring-blue-600"> Update user
                    </button>
                </td>
                <td>
